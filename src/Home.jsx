...
const Home = () => {
  return (
    <>
    <div className="flex justify-center items-center flex flex-col w-full h-full py-[100px] bg-black">
      <img
      ...
      <p className="text-white lg:text-[1rem] pl-[0.5rem] text-opacity-80  mt-[2rem] lg:w-[40%]">
